...
>[!NOTE]
>We have been made aware of an issue where in some cases, security policies for macOS devices are visible in the Endpoint Security policy list view, but not in the device page. We are actively investigating this in order to provide a resolution.
